(function () {
    ...
    const koreanText = {
        ...
        "Read Day 8 →": "8일차 읽기 →",
        "The Model Saw the Grid, Not Just the Dots": "모델은 점뿐 아니라 모눈도 보았다",
        "Road to ICLR · Day 9 / 30": "Road to ICLR · 9일차 / 30",
        "September 1, 2026": "2026년 9월 1일",
        "An interactive visual essay: turn the grid, switch from axes to landmarks, and explore the dial between stability and accuracy.": "모눈을 돌리고, 축에서 기준점 관점으로 바꾸고, 안정성과 정확도 사이의 다이얼을 직접 움직여 보는 인터랙티브 시각 에세이입니다.",
        "Read Day 9 →": "9일차 읽기 →",
