(function () {
    ...
    const koreanText = {
        ...
        "Read Day 10 →": "10일차 읽기 →",
        "Compatibility Is an Arrow, Not an Equals Sign": "호환성은 등호가 아니라 화살표다",
        "Road to ICLR · Day 11 / 30": "Road to ICLR · 11일차 / 30",
        "September 3, 2026": "2026년 9월 3일",
        "Why a richer encoder can serve an old model exactly even when the old representation cannot reconstruct the new one.": "더 풍부한 새 인코더가 과거 모델을 정확히 지원하면서도, 과거 표현은 새 표현을 복원할 수 없는 이유를 살펴봅니다.",
        "Read Day 11 →": "11일차 읽기 →",
