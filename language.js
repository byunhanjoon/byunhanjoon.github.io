(function () {
    ...
    const koreanText = {
        ...
        "Same Table, Different Predictor": "같은 표, 다른 예측기",
        ...
        "How harmless rewrites of the same table can change a prediction, how to measure that hidden risk, and how to repair part of it.": "같은 표를 의미 변화 없이 다시 표현해도 예측이 달라질 수 있는 이유와, 그 숨은 위험을 측정하고 일부를 줄이는 방법을 살펴봅니다.",
        "Read Day 3 →": "3일차 읽기 →",
        "A Feature Is a Domain": "특성은 하나의 도메인입니다",
        "Road to ICLR · Day 4 / 30": "Road to ICLR · 4일차 / 30",
        "August 27, 2026": "2026년 8월 27일",
        "A visual journey from numerical columns to measured function spaces—and why the strongest idea became an audit that chooses its intervention.": "수치형 열에서 측도가 주어진 함수 공간으로 나아가며, 가장 강력한 아이디어가 왜 개입을 선택하는 감사 방법으로 바뀌었는지 살펴봅니다.",
        "Read Day 4 →": "4일차 읽기 →",
