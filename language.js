(function () {
    ...
    const koreanText = {
        ...
        "Read Day 8 →": "8일차 읽기 →",
        "Turning the Paper Shouldn't Change the Answer": "종이를 돌려도 답은 바뀌지 않아야 한다",
        "Road to ICLR · Day 9 / 30": "Road to ICLR · 9일차 / 30",
        "September 1, 2026": "2026년 9월 1일",
        "Why turning the graph paper can change a model's answer—and how familiar landmarks make that answer more dependable.": "모눈종이를 돌리는 것만으로 모델의 답이 바뀌는 이유와 익숙한 기준점으로 그 답을 더 믿을 만하게 만드는 방법을 살펴봅니다.",
        "Read Day 9 →": "9일차 읽기 →",
