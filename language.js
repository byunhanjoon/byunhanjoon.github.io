(function () {
    ...
    const koreanText = {
        ...
        "Read Day 8 →": "8일차 읽기 →",
        "The Same Table Shouldn't Need Lucky Coordinates": "같은 표에 운 좋은 좌표계가 필요해서는 안 된다",
        "Road to ICLR · Day 9 / 30": "Road to ICLR · 9일차 / 30",
        "September 1, 2026": "2026년 9월 1일",
        "Why harmless rotations change tabular predictions—and how a validation guard controls basis dependence without blindly discarding useful bias.": "무해한 회전이 정형 예측을 바꾸는 이유와 검증 가드가 유용한 편향을 무작정 버리지 않으면서 기저 의존성을 제어하는 방법을 살펴봅니다.",
        "Read Day 9 →": "9일차 읽기 →",
